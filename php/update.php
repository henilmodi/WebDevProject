...
<body>
    ...
    <h2>Update</h2><hr>
    <form action="updateconfig.php" method="POST" class="row g-3 needs-validation center row1" novalidate>
        <div class="col-md-5">
        ...
        <div class="col-6">
            <button class="btn btn-primary col-md-7" type="submit">Update</button>
        </div>

        <div class="col-6">
            <button class="btn btn-danger col-md-7" type=""><a href="http://localhost/WDproject1/assets/html/delete.php" class="btn-2">Delete</a></button>
        </div>
    </form>
